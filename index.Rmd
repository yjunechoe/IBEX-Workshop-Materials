...
2. Create a new experiment on your ibex account called "workshop_exercise" and replace the contents of *example_data.js* in the **data_includes** section with _incomplete.js_.
...
If you finish, save and click on your experiment link at the top of the page. Check to see that your experiment looks similar to the [complete version](https://spellout.net/ibexexps/skku_ibex/workshop_exercise/experiment.html).
