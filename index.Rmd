...
<h1 style="text-align:left; margin:15px 0px 0px 0px">Guest<span style="font-size:20px; padding-left:.5em">(Will be answering questions in the chat!)</span></h1>

<img src="https://yjunechoe.github.io/static/img/profile.png" width="150px">



<h2 style="margin:15px 0px 10px 0px"> June Choe</h2>

<h3 style="margin:25px 0px 10px 0px">Ph.D. Student in Linguistics</h3>

<p style="margin-top:0px; padding-bottom:20px; border-bottom: 1px solid white">University of Pennsylvania<br>Philadelphia, PA, USA</p>

Research: psycholinguistics, computational linguistics
<p>
Contact: yjchoe@sas.upenn.edu | <a style="color:white" href="https://yjunechoe.github.io">yjunechoe.github.io</a>
...
.center[**Live demo on Atom**]

.center[_This slide will be updated with solutions_]

<!--
Panelset of solutions for the 8 tasks
-->
...
All materials from this presentation can be found on [github](https://github.com/yjunechoe/IBEX-Workshop-Materials).
...
- The official [google group](https://groups.google.com/g/ibexexperiments/c/-PTeVD39h9o) to ask questions. 
...
- PCIbex (Penn Controller for IBEX) [Link](https://www.pcibex.net)

- PsychoPy [Link](https://www.psychopy.org)

- _magpie (minimal architecture for the generation of portable interactive experiments) [Link](https://magpie-ea.github.io/magpie-site)
...
- MTurk (Amazon Mechanical Turk) [Link](https://www.mturk.com/)

- Prolific [Link](https://www.prolific.co/)
