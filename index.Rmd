...
2. Open it with the `read_ibex()` function [using a script](https://github.com/yjunechoe/IBEX-Workshop-Materials/blob/master/R%20codes/read_ibex.R)
...
<p style='padding-top:15px'>Preferred method because data can get more complicated.</p>
