...
.center[.bl[[["_Trial name_", _Set Number_], "_Experiment Type_", {s: "_Sentence_"}]]]
...
2. A string specifying the _type of the experiment_
...
.center[.bl[For both trials, only minor tweaks are needed!]]

The _first element of the big bracket_ can just be the _name of the stimuli_, since we **don't need to counterbalance** practice and filler trials.
...
<h1 style='margin-bottom:20px'>Putting together the trials</h1>
...
3. How can we implement counterbalancing?
...
**Important** - Matching is sensitive to the ordering of components _as it is written_ inside `var items = []`

---

# Sequence: randomization

<p style='margin-block-end:0;'>To present trials in random order, we use <code>rshuffle()</code></p>
...
**Important**: We want practice trials to always be presented first, so it's not placed inside `rshuffle()`

---

# Sequence: counterbalancing

The .bl[set number] in our critical trials automatically does this:
...
We just need to provide a .bl[counter] inside `var items` that keeps track of this:
...
**Important**: The "setcounter" component should be included _before the trials_.

---

# What we have so far

<embed style='border: 1px solid black' type="text/html" src="snippets/body_sequence.js"  width="800" height="450">
...
A very basic set of settings:

<embed style='border: 1px solid black' type="text/html" src="snippets/settings.js"  width="800" height="330">
