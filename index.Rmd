...
- How can we add _plain text_?
    ...
    - Introduction page, consent form, feedback on practice trials, etc.
...
A list of 3 elements, similar to the "AcceptabilityJudgement" items:
...
- Inside of the curly braces .bl[{}] we can add text for the .bl[html] parameter:
...
Suppose that we find the acceptability judgments to be inappropriate for our answering our research question.

--

We want a _finer-grained measure_ of recovery difficulty, so we'd like to change the experiment to **self-paced reading** and look at reading time differences.
...
3. Make changes to the .bl[Messages] items (directions, feedback on practice trials, etc.)
