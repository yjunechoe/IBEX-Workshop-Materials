...
- June Choe for assistance with the slides (esp. interactive components)
...
- Jon Sprouse (UConn) for permission to use materials from LSA 2016, Experimental Syntax Workshop
    ...
    - Link to Jon's current course on Introduction to Experimental Syntax Methods: [https://sprouse.uconn.edu/courses/experimental-syntax](https://sprouse.uconn.edu/courses/experimental-syntax)
