...
We now have a [minimally working experiment](/ibexexps/skku_ibex/workshop_minimal/experiment.html)!
...
Note how the our settings in `var defaults` are reflected in the trials:
...
Here's a [complete experiment](/ibexexps/skku_ibex/workshop_acceptabilityJudgment/experiment.html) with .bl[Message] controllers added.
