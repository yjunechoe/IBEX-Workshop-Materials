...
.center[.bl[[["_Trial name_", _Set #_], "_Experiment Type_", {s: "_Sentence_"}]]]
...
.center[.bl[For both types of trials, only minor tweaks are needed!]]
...
<h1 style='margin-bottom:20px'>Putting together all stimuli</h1>
...
1. Generate unique **participant IDs** (`var randomCode`)

2. Specify the **method design** (in `var defaults`)

<embed style='border: 1px solid black' type="text/html" src="snippets/settings.js"  width="800" height="250">
...
You can learn more about these various elements in [the documentation](https://github.com/addrummond/ibex/blob/master/docs/manual.md#miscellaneous--options).

---

# A minimal experiment

We have a [minimally working experiment](/ibexexps/skku_ibex/workshop_minimal/experiment.html)!
...
- <p>We use a special syntax to define trials</p>
