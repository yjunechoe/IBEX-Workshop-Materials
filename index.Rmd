...
2. Specify the parameters for the **method design** (in `var defaults`)
...
You can learn more about these various elements in .bl[Miscellaneous options] section of the [documentation](https://github.com/addrummond/ibex/blob/master/docs/manual.md).
