...
var defaults = [
    "AcceptabilityJudgment", {
       as: ["1", "2", "3", "4", "5"], // Task #2: Make the acceptability judgment scale from 1-5
       presentAsScale: true,
...
var shuffleSequence = seq(
  ...
  "Consent",
  "Directions",
  "SetCounter", // Task #3: Insert the trial that updates the participant counter
  startsWith("Exposure"), // Task #4: Select all exposure trials
  "Transition",
  rshuffle(startsWith("Condition"), startsWith("Filler")) // Task #5: Use the function that randomly shuffle the critical and filler trials
)
...
var items = [
  ...
  ["Transition", "Message", {
    html: ["div", ["p", "How was that for practice?"], ["p", "Now let's start the experiment."]]
  }],
  ...
  [["ConditionA",2], "AcceptabilityJudgment", {s: "No bill that the Democratic senators supported has ever become law."}],
  [["ConditionB",2], "AcceptabilityJudgment", {s: "The bill that the Democratic senators supported has ever become law."}],

  // Task #8: Create a filler trial called "Filler-catch-01" that asks participants to "Select '2' for this sentence.".
  ["Filler-catch-01", "AcceptabilityJudgment", {s: "Select '2' for this sentence."}],
