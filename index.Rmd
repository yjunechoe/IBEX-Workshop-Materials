...
For self-paced reading with .b["DashedSentence"], we get **5** more columns:
...
For the analysis of the results, we need the results to be imported as a **data frame** (where every value is a cell and each variable forms a column). 
